...
target = df(known_data['return'])
target = target.values.ravel()
train_data = train_data.pop('return')
...
x_train, x_test, y_train, y_test = train_test_split(train_data, target, test_size = 0.30)
